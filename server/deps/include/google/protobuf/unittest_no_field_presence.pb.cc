...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_TestAllTypes_default_instance_), oneof_enum_),
...
::google::protobuf::uint8* TestAllTypes::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->repeated_proto2_message_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        50, this->repeated_proto2_message(i), deterministic, target);
  }
