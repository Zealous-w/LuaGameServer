...
class AnyData_MapDataEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<AnyData::AnyData_MapDataEntry> {
...
class StringtoIntMap_MapEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<StringtoIntMap::StringtoIntMap_MapEntry> {
...
class IntToStringMap_MapEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<IntToStringMap::IntToStringMap_MapEntry> {
...
class MixedMap_MapEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<MixedMap::MixedMap_MapEntry> {
...
class MixedMap2_MapEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<MixedMap2::MixedMap2_MapEntry> {
...
class MessageMap_MapEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<MessageMap::MessageMap_MapEntry> {
...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_DoubleMessage_default_instance_), str_value_),
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_DoubleMessage_default_instance_), num_value_),
...
file_level_metadata[7].reflection = AnyData::AnyData_MapDataEntry::CreateReflection(file_level_metadata[7].descriptor, _AnyData_MapDataEntry_default_instance_.get_mutable());
file_level_metadata[9].reflection = StringtoIntMap::StringtoIntMap_MapEntry::CreateReflection(file_level_metadata[9].descriptor, _StringtoIntMap_MapEntry_default_instance_.get_mutable());
file_level_metadata[11].reflection = IntToStringMap::IntToStringMap_MapEntry::CreateReflection(file_level_metadata[11].descriptor, _IntToStringMap_MapEntry_default_instance_.get_mutable());
file_level_metadata[13].reflection = MixedMap::MixedMap_MapEntry::CreateReflection(file_level_metadata[13].descriptor, _MixedMap_MapEntry_default_instance_.get_mutable());
file_level_metadata[15].reflection = MixedMap2::MixedMap2_MapEntry::CreateReflection(file_level_metadata[15].descriptor, _MixedMap2_MapEntry_default_instance_.get_mutable());
file_level_metadata[18].reflection = MessageMap::MessageMap_MapEntry::CreateReflection(file_level_metadata[18].descriptor, _MessageMap_MapEntry_default_instance_.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _AnyData_MapDataEntry_default_instance_.DefaultConstruct();
  _AnyData_default_instance_.DefaultConstruct();
  _StringtoIntMap_MapEntry_default_instance_.DefaultConstruct();
  _StringtoIntMap_default_instance_.DefaultConstruct();
  _IntToStringMap_MapEntry_default_instance_.DefaultConstruct();
  _IntToStringMap_default_instance_.DefaultConstruct();
  _MixedMap_MapEntry_default_instance_.DefaultConstruct();
  _MixedMap_default_instance_.DefaultConstruct();
  _MixedMap2_MapEntry_default_instance_.DefaultConstruct();
  _MixedMap2_default_instance_.DefaultConstruct();
  _MessageMap_M_default_instance_.DefaultConstruct();
  _MessageMap_MapEntry_default_instance_.DefaultConstruct();
  ...
  _AnyData_MapDataEntry_default_instance_.get_mutable()->set_default_instance(_AnyData_MapDataEntry_default_instance_.get_mutable());
  _AnyData_MapDataEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
  ...
  _AnyData_default_instance_.get_mutable()->struct_data_ = const_cast< ::google::protobuf::Struct*>(
      ::google::protobuf::Struct::internal_default_instance());
  _StringtoIntMap_MapEntry_default_instance_.get_mutable()->set_default_instance(_StringtoIntMap_MapEntry_default_instance_.get_mutable());
  _StringtoIntMap_MapEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
  _IntToStringMap_MapEntry_default_instance_.get_mutable()->set_default_instance(_IntToStringMap_MapEntry_default_instance_.get_mutable());
  _IntToStringMap_MapEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
  _MixedMap_MapEntry_default_instance_.get_mutable()->set_default_instance(_MixedMap_MapEntry_default_instance_.get_mutable());
  _MixedMap_MapEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
  _MixedMap2_MapEntry_default_instance_.get_mutable()->set_default_instance(_MixedMap2_MapEntry_default_instance_.get_mutable());
  _MixedMap2_MapEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
  _MessageMap_MapEntry_default_instance_.get_mutable()->set_default_instance(_MessageMap_MapEntry_default_instance_.get_mutable());
  _MessageMap_MapEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
...
::google::protobuf::uint8* DoubleMessage::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->repeated_nested_message_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        4, this->repeated_nested_message(i), deterministic, target);
  }
...
;
  ...
  for (unsigned int i = 0, n = this->repeated_data_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        9, this->repeated_data(i), deterministic, target);
  }
