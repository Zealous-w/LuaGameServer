...
class TestJsonName1DefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<TestJsonName1> {
} _TestJsonName1_default_instance_;
class TestJsonName2DefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<TestJsonName2> {
...
void TableStruct::Shutdown() {
  ...
  _TestJsonName1_default_instance_.Shutdown();
  delete file_level_metadata[11].reflection;
  _TestJsonName2_default_instance_.Shutdown();
...
void TableStruct::InitDefaultsImpl() {
  ...
  _TestJsonName1_default_instance_.DefaultConstruct();
  _TestJsonName2_default_instance_.DefaultConstruct();
...
::google::protobuf::uint8* Book::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->labels_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        10, this->labels(i), deterministic, target);
  }
...
::google::protobuf::uint8* Author::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->friend__size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        5, this->friend_(i), deterministic, target);
  }
...
::google::protobuf::uint8* Cyclic::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->m_author_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        5, this->m_author(i), deterministic, target);
  }
...
void TestJsonName1::InternalSwap(TestJsonName1* other) {
  std::swap(one_value_, other->one_value_);
  std::swap(_has_bits_[0], other->_has_bits_[0]);
  _internal_metadata_.Swap(&other->_internal_metadata_);
  std::swap(_cached_size_, other->_cached_size_);
}
...
void TestJsonName2::InternalSwap(TestJsonName2* other) {
  std::swap(another_value_, other->another_value_);
  std::swap(_has_bits_[0], other->_has_bits_[0]);
  _internal_metadata_.Swap(&other->_internal_metadata_);
  std::swap(_cached_size_, other->_cached_size_);
}
