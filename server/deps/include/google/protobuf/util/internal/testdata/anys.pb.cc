...
class Data_MapDataEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<Data::Data_MapDataEntry> {
...
file_level_metadata[3].reflection = Data::Data_MapDataEntry::CreateReflection(file_level_metadata[3].descriptor, _Data_MapDataEntry_default_instance_.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Data_MapDataEntry_default_instance_.DefaultConstruct();
  ...
  _Data_MapDataEntry_default_instance_.get_mutable()->set_default_instance(_Data_MapDataEntry_default_instance_.get_mutable());
  _Data_MapDataEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
